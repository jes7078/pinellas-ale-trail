...
const AddStyle = () => {
	...
	const addIt = async (e) => {
		e.preventDefault()
		const resp = await axios.post(`https://pinellas-ale-trail.herokuapp.com/api/BeerStyle`, beerStyle)
	...
	const deleteit = async (e, beerStyle) => {
		e.preventDefault()
		const resp = await axios.delete('https://pinellas-ale-trail.herokuapp.com/api/BeerStyle/' + beerStyle.id)
		if (resp.statusText === 'OK') {
